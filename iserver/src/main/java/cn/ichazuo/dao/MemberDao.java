...
//	public Member findMemberByMobile(String mobile);
	...
	public int saveBusinessBlockDetail(BlockDetail block);
	...
	public int updateEmployeeSubloginSign(Map<String,Object> params);
	 ...
	 * @return
	 */
	public List<LoginDetail> queryEmployeeCloseMsg(Map<String,Object> params);
	
	/**
	 * @Title: queryWhiteListByMobile 
	 * @Description: (查询手机号码是否在验证码白名单) 
	 * @param mobile 手机号
	 * @return
	 */
	public List<WhiteList> queryWhiteListByMobile(Map<String,Object> params);
	 ...
	 * @return
	 */
	public List<BlockDetail> queryBlockList(Map<String,Object> params);
	/**
	 * @Title: updateBusinessUserPassword 
	 * @Description: (修改企业用户密码) 
	 * @param employee 企业用户
	 * @return
	 */
	public List<BlockDetail> queryLastBlockList(Map<String,Object> params);
	/**
	 ...
	 * @return
	 */
	public int registerEmployeeXL(Employee employee);
	/**
	 * @Title: insertMemberRecord 
	 * @Description: (保存用户购买好多课会员记录) 
	 * @param MemberRecord 企业版App会员购买记录
	 * @return
	 */
	public int insertMemberRecord(MemberRecord record);
	
	public int insertMemberRecord2(MemberRecord record);
	
	public int insertMemberRecord3(MemberRecord record);
	
	public int insertWeixinGift(WeixinGift weixinGift);
	/**
	 * @Title: insertMemberRecord1 
	 * @Description: (保存用户购买好多课会员记录) 
	 * @param MemberRecord 企业版App会员购买记录
	 * @return
	 */
	public int insertMemberRecord1(MemberRecord record);
	 ...
	 * @return
	 */
	public int insertMemberSeries(MemberRecord record);
	public int insertMemberSeries1(MemberRecord record);
