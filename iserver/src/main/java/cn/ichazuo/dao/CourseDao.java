...
public interface CourseDao {
	...
	public List<OfflineCourseListInfo> findOfflineCourseListOffical(Map<String,Object> params);
	...
	/**
	 * @Title: findCatalogInfoById 
	 * @Description: (根据Id查询系列课) 
	 * @param id
	 * @return
	 */
	...
	public int saveCourseClickDetail(CourseClickDetail detail);
	...
	public int updateZuoWei(Map<String,Object> map);
	...
	public List<OfflineJoinMember> findOfflineJoinForSignedDaKe(Map<String,Object> map);
	...
	public String findOfflineJoinMobileForSignedDaKe(Map<String,Object> map);
	...
	public String findOfflineJoinNameForSignedDaKe(Map<String,Object> map);
	
	/**
	 * @Title: findOfflineJoinCompanyForSigned 
	 * @Description: (根据手机号码查询线下课程报名用户公司：检票用) 
	 * @param map
	 * @return
	 */
	public String findOfflineJoinCompanyForSigned(Map<String,Object> map);
	public String findOfflineJoinCompanyForSignedDaKe(Map<String,Object> map);
	/**
	 * @Title: findOfflineJoinJobForSigned 
	 * @Description: (根据手机号码查询线下课程报名用户职位：检票用) 
	 * @param map
	 * @return
	 */
	public String findOfflineJoinJobForSigned(Map<String,Object> map);
	public String findOfflineJoinJobForSignedDaKe(Map<String,Object> map);
	/**
	...
	public String OfflineSignedDaKe(Map<String,Object> map);
	...
	public String OfflineSignedAllDaKe(Map<String,Object> map);
	...
	public List<OfflineSigned> findOfflineSignedJoinListShangDaKe(Map<String,Object> map);
	public List<OfflineJoinMember> findOfflineJoinMemberByMobile(Map<String,Object> map);
	public List<OfflineJoinMember> findOfflineJoinMemberByMobileDaKe(Map<String,Object> map);
	/**
	...
	public List<OfflineSigned> findOfflineSignedJoinListXiaDaKe(Map<String,Object> map);
	...
	public List findOfflineSignedMobileListShangDaKe(Map<String,Object> map);
	/**
	...
	public List<OfflineSigned> findOfflineSignedMobileListXiaDaKe(Map<String,Object> map);
	
	//根据课程Id查询审核通过的线下课程学员信息列表，用于发送结业证书
	public List<MemberInfoForEmail> queryMemberListByCourseIdForEmail(Map<String,Object> map);
	...
	public List<OfflineJoinMember> findOfflineNotSignedMobileListShangDaKe(Map<String,Object> map);
	/**
	 * @Title: findOfflineSignedMobileListXia 
	 * @Description: (查询线下课程签到列表：检票用) 
	 * @param map
	...
	public List<OfflineJoinMember> findOfflineNotSignedMobileListXiaDaKe(Map<String,Object> map);
	...
	public List<OfflineJoinMember> findOfflineNotSignedListDaKe(Map<String,Object> map);
	
	public List<DaKe> findList(Map<String,Object> map);
	 ...
	 * @return
	 */
	public int saveJNCourseJoin(JNCourseOnlineJoin join);
	/**
	 * @Title: findJNCourseJoin 
	 * @Description: (查询线下课程报名信息) 
	 * @param params 参数
	 * @return
	 */
	public JNCourseOnlineJoin findJNCourseJoin(Map<String,Object> params);
}
