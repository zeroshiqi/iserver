 ...
 * @version V1.0
 */
public class CatalogCourseList extends BaseResult {
	...
	private String ifTitle;//是否需要在音频播放时加上片头和片尾 
	//标新
	private String isnew;
	private String ifBusiness;
	private String isChoose;//是否选课 0：未选课，1：选课。
	
	private String testMark;//参加测试标识
