...
public class OrderService extends BaseService {
	 ...
	 * @return
	 */
	public boolean updateCourseOrderByOrderNo(WebCourseOrder order) {
		orderDao.updateCourseOrderByOrderNo(order);
		return true;
	}
	 ...
	 * @return
	 */
	public boolean saveLiveGiftOrder(LiveGiftOrder order) {
		orderDao.saveLiveGiftOrder(order);
		return true;
	}
	 ...
	 * @return
	 */
	public boolean updateLiveGiftOrderByOrderNo(LiveGiftOrder order) {
		orderDao.updateLiveGiftOrderByOrderNo(order);
		return true;
	}
	/**
	 ...
	 * @return
	 */
	public boolean updateGiftDetailByOrderNo(WebCourseOrder order) {
		orderDao.updateGiftDetailByOrderNo(order);
		return true;
	}
	...
	/**
	 * @Title: findLiveGiftOrder
	 * @Description: (查询WEB订单信息)
	 * @param code
	 * @return
	 */
	public LiveGiftOrder findLiveGiftOrder(String code) {
		return orderDao.findLiveGiftOrder(code);
	}
	 ...
	 * @param courseId
	 */
	public void updateLiveGiftOrderStatus(Long orderId) {
		orderDao.updateLiveGiftOrderStatus(orderId);
	}
	...
	public String findWebOrderReviewStatus(Long courseId, String unionId) {
		Map<String, Object> data = new HashMap<>();
		data.put("courseId", courseId);
		data.put("unionId", unionId);
		return orderDao.findWebOrderReviewStatus(data);
	}
	
	public String findWebOrderCode(Long courseId, String unionId) {
		Map<String, Object> data = new HashMap<>();
		data.put("courseId", courseId);
		data.put("unionId", unionId);
		return orderDao.findWebOrderCode(data);
	}
	...
	public List<JNWebCourseOrder> getWhetherYearByUnionid(String unionid){
		Params params = new Params();
		params.putData("unionid", unionid);
		return orderDao.getWhetherYearByUnionid(params.getMap());
	}
	public List<WebCourseOrder> getIfBuyCourseByUnionid(String unionid){
		Params params = new Params();
		params.putData("unionid", unionid);
		return orderDao.getIfBuyCourseByUnionid(params.getMap());
	}
	public List<WebCourseOrder> getIfBuyCourseByMobile(String mobile){
		Params params = new Params();
		params.putData("mobile", mobile);
		return orderDao.getIfBuyCourseByMobile(params.getMap());
	}
	
	public List<SelfCourseOrder> queryOrderListByUnionid(String unionid){
		Params params = new Params();
		params.putData("unionid", unionid);
		return orderDao.queryOrderListByUnionid(params.getMap());
	}
	public List<SelfCourseOrder> queryOrderListByMobile(String mobile){
		Params params = new Params();
		params.putData("mobile", mobile);
		return orderDao.queryOrderListByMobile(params.getMap());
	}
	public List<SelfCourseOrder> queryOrderListByUnionidAndCourseId(String unionid,Long courseId){
		Params params = new Params();
		params.putData("unionid", unionid);
		params.putData("courseId", courseId);
		return orderDao.queryOrderListByUnionidAndCourseId(params.getMap());
	}
	public List<MemberRecord> queryMemberRecordByUnionId(String unionid){
		Params params = new Params();
		params.putData("unionid", unionid);
		return orderDao.queryMemberRecordByUnionId(params.getMap());
	}
	public List<MemberRecord> queryMemberRecordByUnionIdAndCatalogId(String unionid,int catalogId){
		Params params = new Params();
		params.putData("unionid", unionid);
		params.putData("catalogId", catalogId);
		return orderDao.queryMemberRecordByUnionIdAndCatalogId(params.getMap());
	}
	
	public List<WebCourseOrder> getOrderByOrderNo(String orderNo){
		Params params = new Params();
		params.putData("orderNo", orderNo);
		return orderDao.getOrderByOrderNo(params.getMap());
	}
}
