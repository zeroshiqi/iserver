package cn.ichazuo.commons.util.ueditor;
...
public class Uploader {
	...
	static {
		try {
			String path = Uploader.class.getResource("/").getPath();
			File file = null;
			try {
				file = new File(path, "configInfo.properties");
			} catch (Exception e) {
				file = new File(path, File.pathSeparator + "configInfo.properties");
			}
